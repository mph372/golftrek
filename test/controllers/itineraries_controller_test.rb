...
class ItinerariesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create itinerary" do
    assert_difference("Itinerary.count") do
      post itineraries_url, params: { itinerary: { end_date: @itinerary.end_date, public_itinerary: @itinerary.public_itinerary, start_date: @itinerary.start_date, title: @itinerary.title, user_id: @itinerary.user_id } }
    end
  ...
  test "should update itinerary" do
    patch itinerary_url(@itinerary), params: { itinerary: { end_date: @itinerary.end_date, public_itinerary: @itinerary.public_itinerary, start_date: @itinerary.start_date, title: @itinerary.title, user_id: @itinerary.user_id } }
